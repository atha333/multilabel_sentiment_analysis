...
class Trainer(object):
    ...
    def __init__(self, model, train_data_loader, val_data_loader, filename):
        ...
        self.early_stop = EarlyStopping(self.filename, patience=4)
    ...
    def fit(self, num_epochs, args, device='cuda:0'):
        ...
        for epoch in pbar:
            ...
            overall_val_loss, pred_dict = self.predict(args['--dataset'],device, pbar)
    ...
    def predict(self,dataset, device='cuda:0', pbar=None):
        """
